...
{
    internal class DEC_RegMem : TwoByteInstruction
    {
        public DEC_RegMem(byte opCode, IExecutionUnit eu, IBus bus) : base(opCode, eu, bus) { }
        ...
        protected override void ExecuteInstruction()
        {
            ...
            EU.CondReg.CalcOverflowSubtract(1, source, dest);
